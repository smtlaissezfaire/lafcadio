...
class ObjectStore < ContextualService
  ...
  def getAll(objectType)
	...
	# Returns a collection of domain objects that correspond to the Condition or 
	# Query. This queries the database for only the relevant objects, and as such 
	# can offer significant time savings over retrieving all the objects and then 
	# filtering them in Ruby.
